...
// `hero-glass-transmission.wgsl`, which shades the same geometry.
...
// The stretch is diagonal, so that reduces to a component-wise divide. Scaling
// the position without this leaves the shading on the un-stretched shape.
