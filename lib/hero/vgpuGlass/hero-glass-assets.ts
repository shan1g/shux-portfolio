...
const GLASS_MESH_URL = "/hero/glass-fractal/rounded-tetrahedron.mesh";
const FRACTAL_MESH_URL = "/hero/glass-fractal/fractal-tetrahedron-l7.mesh";
const ENVIRONMENT_URL = "/hero/glass-fractal/studio-cubemap-prefiltered.png";
